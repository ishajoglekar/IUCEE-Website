...
<label>
    ...
    <?php endif; ?>
    <div class="prologe-range-value"><?php echo esc_attr($this->value()); ?></div>
...
<?php
    ...
    <h1><?php esc_html_e('Prologe - Premium', 'prologe-lite') ?></h1>
    ...
    <p><a class="rp-get-pro button" href="<?php echo esc_url('https://www.roughpixels.com/gutenberg-themes/prologe/'); ?>" target="_blank"><?php esc_html_e( 'Save $10 Now', 'prologe-lite' ); ?></a></p>			
